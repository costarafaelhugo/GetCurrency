package com.hugorafaelcosta.currenciecoverter

import android.os.Bundle
import android.widget.*
import androidx.appcompat.app.AppCompatActivity
import com.google.gson.JsonObject
import com.hugorafaelcosta.currenciecoverter.api.EndPoint
import com.hugorafaelcosta.currenciecoverter.util.NetworkUtils
...
class MainActivity : AppCompatActivity() {
    ...
    fun convertMoney(){
        ...
        endpoint.getCurreciesRate(spFrom.selectedItem.toString(), spTo.selectedItem.toString()).enqueue(object :
